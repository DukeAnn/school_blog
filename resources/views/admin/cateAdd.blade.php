        ...
        <div class="col-sm-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" id="cateadd" class="form-horizontal" action="{{ url('admin/catesave') }}" method="post">
                        {{--防跨站攻击--}}
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group-separator"></div>
                        <button type="submit" class="btn btn-info btn-single pull-right">添加分类</button>
                    </form>
